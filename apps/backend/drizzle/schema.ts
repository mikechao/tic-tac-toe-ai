...
export const games = pgTable(
  ...
  (table) => ({
    matchRoundUnique: uniqueIndex('games_match_round_unique').on(
      table.matchId,
      table.round,
    ),
  }),
...
export const moves = pgTable(
  ...
  (table) => ({
    moveIndexUnique: uniqueIndex('moves_game_move_idx_unique').on(
      table.gameId,
      table.moveIndex,
    ),
    movePositionUnique: uniqueIndex('moves_game_position_unique').on(
      table.gameId,
      table.position,
    ),
  }),
