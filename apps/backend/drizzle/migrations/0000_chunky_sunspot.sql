...
CREATE UNIQUE INDEX "model_stats_model_id_version_unique" ON "model_stats" USING btree ("model_id","model_version");--> statement-breakpoint
CREATE UNIQUE INDEX "moves_round_turn_unique" ON "moves" USING btree ("round_id","turn_index");--> statement-breakpoint
CREATE UNIQUE INDEX "recent_matches_model_version_index_unique" ON "recent_matches" USING btree ("model_id","model_version","match_index");--> statement-breakpoint
CREATE UNIQUE INDEX "recent_matches_model_version_match_unique" ON "recent_matches" USING btree ("model_id","model_version","match_id");