...
CREATE UNIQUE INDEX IF NOT EXISTS "moves_round_turn_unique" ON "moves" ("round_id", "turn_index");
CREATE UNIQUE INDEX IF NOT EXISTS "matches_match_round_unique" ON "matches" ("match_id", "current_round");
